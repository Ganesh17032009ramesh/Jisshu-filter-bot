...
BOT_TOKEN = environ.get('BOT_TOKEN', '8191914032:AAGr4VP7mIkmtu2lcCySQ0-VC6fo5SXh25U')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1918079773').split()]
USERNAME = environ.get('USERNAME', "https://t.me/Cr3atives_Cortexx") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002423270359'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+r6gFFy1knfw3YTBl')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002423270359').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002423270359'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','0')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002423270359'))
auth_channel = environ.get('AUTH_CHANNEL', '')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002316830261'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002423270359') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002423270359')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+PSjY-tow7ukyNDQ1') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
...
SHORTENER_API = environ.get("SHORTENER_API", "00039eb814cd3bb235861f83e548751ddf814da3")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'instantlinks.co')
SHORTENER_API2 = environ.get("SHORTENER_API2", "00039eb814cd3bb235861f83e548751ddf814da3")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'instantlinks.co')
SHORTENER_API3 = environ.get("SHORTENER_API3", "00039eb814cd3bb235861f83e548751ddf814da3")
